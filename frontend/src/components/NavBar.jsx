    ...
    <header className={`sticky top-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        ...
        <div className="flex items-center space-x-3 group cursor-pointer">
          <div className={`relative flex flex-col items-center justify-center w-12 h-12 rounded-full transition-all duration-300 group-hover:scale-110 ${
        ...
        <nav className="hidden md:flex items-center space-x-1">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon size={18} className={`mr-2 transition-transform duration-300 ${
          ...
          >
            <button className={`flex items-center px-4 py-2 rounded-xl font-medium transition-all duration-300 group ${
              scrolled
            ...
            <div className={`absolute top-full left-0 mt-2 w-64 bg-white/95 backdrop-blur-lg shadow-2xl rounded-2xl border border-gray-200/50 transform transition-all duration-300 ${
